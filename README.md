...
snhc-web changes this location through the `.bowerrc` file.  Putting it in the app folder makes
...
The snhc-web project comes preconfigured with a local development webserver.  It is a node.js
